%% S3 Fig: To plot time course after block averaging for each condition over all subjects
clear all
clc
...
% Delete the following subjects due to noise according to exp note and
% individual patterns
